...
function isfilled() {
    ...
    if (password==null || password==""){
        document.getElementById("txtHint").innerHTML="请输入密码";
    }else {
        document.getElementById("txtHint").innerHTML="";
        flag++;
    }
    ...
    if (password2==null || password2==""){
        document.getElementById("txtHint").innerHTML="请确认密码";
    }else {
        document.getElementById("txtHint").innerHTML="";
        flag++;
    }
    ...
    if (email==null || email==""){
        document.getElementById("txtHint").innerHTML="请输入邮箱";
    }else {
        document.getElementById("txtHint").innerHTML="";
        flag++;
    }
    ...
    if (checkNumb==null || checkNumb==""){
        document.getElementById("txtHint").innerHTML="请输入验证码";
    }else {
        document.getElementById("txtHint").innerHTML="";
        flag++;
    }
