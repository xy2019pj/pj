...
function creatPage(nowN) {
    var form="";
    for(var i=0;i<3&&((nowN*9+i*3)<items.length);i++){
        form+="<div class=\"row clearfix\">";
        for(var j=0;(j<3) && ((nowN*9+i*3+j)<items.length);j++){
            form+="<div class=\"col-md-4 column\">\n" +
                "            <div class=\"imgcontrol\">\n" +
                "                <img src=\"" +
                items[nowN*9+i*3+j].picture +
                "\" align=\"center\">\n" +
                "            </div>\n" +
                "            <h2>\n" +
                items[nowN*9+i*3+j].name +
                "            </h2>\n" +
                "            <p>\n" +
                items[nowN*9+i*3+j].intro+
                "            </p>\n" +
                "            <p>\n" +
...
function changeBtn() {
    ...
    switch (nowPI) {
        ...
        break;
        case 1:t+=1; m+=1;forms[1]="<a onclick=\"btnEvent(" +t+")\" style=\"background-color: #0c3347;color: #e2e2e2\">" +m+ "</a>"
        break;
        case 2:t+=2; m+=2;forms[2]="<a onclick=\"btnEvent(" +t+")\" style=\"background-color: #0c3347;color: #e2e2e2\">" +m+ "</a>"
        break;
        case 3:t+=3; m+=3;forms[3]="<a onclick=\"btnEvent(" +t+")\" style=\"background-color: #0c3347;color: #e2e2e2\">" +m+ "</a>"
        break;
        case 4:t+=4; m+=4;forms[4]="<a onclick=\"btnEvent(" +t+")\" style=\"background-color: #0c3347;color: #e2e2e2\">" +m+ "</a>"
    }
    for(var i=0;i<5;i++){
        console.log("||"+forms[i]+"(pageNs[i]="+pageNs[i]+";t="+t+";m="+m);
    }
